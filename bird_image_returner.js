// gallery_image_retriever.js
document.addEventListener("DOMContentLoaded", function () {
    // Target the <div> where you want to display the images
    const imgContainer = document.getElementById("birds");

    // Define the parameters you want to send
    const params = new URLSearchParams();
    params.append("imgType", "Coastal Bird"); // Replace with your parameter name and value
